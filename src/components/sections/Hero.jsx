      ...
      <div className="max-w-4xl mx-auto text-center">
        <FadeIn delay={0.1}>
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-100 shadow-sm text-sm font-medium text-gray-600 mb-8">
            ...
            <span>Agence digitale N°1 à Ziguinchor</span>
          </div>
        </FadeIn>
        
        <FadeIn delay={0.2}>
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-primary tracking-tight leading-tight mb-6">
            Je propulse vos marques vers le <span className="text-secondary relative">
              succès digital
              <svg className="absolute -bottom-2 left-0 w-full" viewBox="0 0 200 8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 6C40.5 -1.5 160 -1.5 199 6" stroke="#FF6633" strokeWidth="3" strokeLinecap="round"/></svg>
            </span>
          </h1>
        </FadeIn>
        ...
        <FadeIn delay={0.3}>
          <p className="text-xl md:text-2xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
            Création de sites web ultra-performants et gestion stratégique de vos réseaux sociaux pour transformer vos visiteurs en clients.
          </p>
        </FadeIn>
